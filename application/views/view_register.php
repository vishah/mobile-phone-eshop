        ...
        <div class="container-fluid" style="padding:0px;">
            ...
            <div class="row">
                ...
                <div class="col-md-6"><!-- main body col -->
                    <h2>Create a MyPhone Account</h2>
                    <div class="bg-warning">
                        <?=validation_errors(); ?>
                    </div>
                    <?=form_open('register'); ?>                        
                    <div class="form-group">
                        <label for="inputPhoneNo">Mobile Number</label>
                        <input type="text" class="form-control" id="inputPhoneNo" name="phoneno" placeholder="" value="<?=set_value('phoneno');?>">
                    </div>                        
                    <div class="form-group">
                        <label for="inputEmail">Email address</label>
                        <input type="email" class="form-control" id="inputEmail" name="email" placeholder="Email" value="<?=set_value('email');?>">
                    </div>
                    <div class="form-group">
