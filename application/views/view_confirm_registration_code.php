        ...
        <div class="container-fluid" style="padding:0px;">
            ...
            <div class="row">
                ...
                <div class="col-md-6"><!-- main body col -->
                    <h2>Enter the code received to your mobile no.</h2>
                    <div class="bg-warning">
                        <?=validation_errors(); ?>
			                  <?=$message; ?>
                    </div>
                    <?=form_open('confirm_code'); ?>                        
                    <div class="form-group">
                        <label for="inputCode">Code</label>
                        <input type="text" class="form-control" id="inputCode" name="code" placeholder="" value="<?=set_value('code');?>">
                    </div>                        
